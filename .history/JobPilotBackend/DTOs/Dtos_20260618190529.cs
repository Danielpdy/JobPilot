...
public record InterviewConfigDto(string JobTitle, string InterviewType, string DifficultyType, string QuestionCount);
public record InterviewQuestionDto(Guid InterviewId, int QuestionNumber, string Question);
