...
public record CoverLetterInputDto(IFormFile? File, int? resumeId string Company, string JobTitle, string JobDescription, string Tone);
public record CoverLetterOutputDto(IFormFile File);
