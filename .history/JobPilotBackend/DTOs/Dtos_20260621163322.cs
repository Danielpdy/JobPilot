...
public record InterviewConfigDto(string JobTitle, string InterviewType, string DifficultyType, string QuestionCount, string JobDescriptionText);
public record InterviewStartDto(int InterviewId, int QuestionNumber, string Question);
